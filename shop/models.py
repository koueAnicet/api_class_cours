...
class Category(models.Model):
    ...
    def __str__(self):
        return self.name
    """
    Il est toujours préférable de rapprocher le code métier 
    du model afin de pouvoir l’exécuter plus facilement. 
    Faisons cela, et notre action en sera alors simplifiée.
    """
    @transaction.atomic
    def disable(self):
...
class Product(models.Model):
    ...
    #import d'api externe de Food Open Fact
